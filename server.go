...
// sendTasksGroupedByProjectAsync is like sendTasksGroupedByProject but for async processing
// It doesn't send the initial message since that's already sent to prevent timeout
