...
graph TD
    ...
    DevPath --> D1[Clone Repository<br/>git clone repo]
    D1 --> D2[Install Dependencies<br/>go mod download]
    D2 --> D3[Setup Database<br/>PostgreSQL local/Docker]
    D3 --> D4[Configure Environment<br/>Create .env file]
    D4 --> D5[Initialize Database<br/>./oye --init-db]
    D5 --> D6[Test Installation<br/>./oye --build-test]
    D6 --> DevReady[✅ Ready for Development]
    
    ProdPath --> P1[Choose Platform<br/>Railway/Docker/Binary]
    P1 --> P2[Configure Database<br/>PostgreSQL hosted]
    P2 --> P3[Set Environment<br/>Production variables]
    P3 --> P4[Deploy Application<br/>Build & deploy]
    P4 --> P5[Initialize Database<br/>./oye --init-db]
    P5 --> P6[Configure Slack<br/>Create app & commands]
